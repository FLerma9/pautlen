...
int main (int argc, char ** argv)
{
    ...
    //Declaramos la funcion. Vamos a imprimir su etiqueta y decir que tiene unavariable local.
    //function int doble(int arg)
    //{
    // int auxArg;
    declararFuncion(fd_asm,"doble",1);
    //auxArg = arg; Asignacion de parametro a variable local. Solo hay unparametro.
    ...
    // printf doble(z)
    //Llamamos a la funcion que tiene 1 argumento. Estamos dando un salto a laetiqueta. Primero apilamos el parametro.
