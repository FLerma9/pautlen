...
clase_escalar   :   tipo    {ECHOYYPARSE(9, "<clase_escalar> ::= <tipo>");}
...
declaraciones_funcion       :   declaraciones   {ECHOYYPARSE(28, "<declaraciones_funcion> ::= <identificador> <identificador>");}
...
exp             :   exp '+' exp     {$$ = $1 + $3; ECHOYYPARSE(72, "<exp> ::= <exp> + <exp>");}
                ...
                |   identificador       {$$ = 0; ECHOYYPARSE(80, "<exp> ::= <identificador>");}
...
constante       :   constante_logica {$$ = $1; ECHOYYPARSE(99, "<constante> ::= <constante_logica>");}
                |   constante_entera {$$ = $1; ECHOYYPARSE(100, "<constante> ::= <constante_entera>");}
          
constante_logica    :   TOK_TRUE {$$ = $1; ECHOYYPARSE(102, "<constante_logica> ::= true");}
                    |   TOK_FALSE {$$ = $1; ECHOYYPARSE(99, "<constante_logica> ::= false");}

constante_entera :  TOK_CONSTANTE_ENTERA    {$$ = $1; ECHOYYPARSE(104, "<constante_entera> ::= numero");}
